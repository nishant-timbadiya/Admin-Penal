        ...
        <div className="grid lg:grid-cols-4 grid-cols-2 border rounded-md p-5 items-center bg-blue-100">
            <div class=" col-span-3">
              ...
              <div class="mb-4">
                ...
                <input type="text" name="category" id="category" class="mt-1 p-2 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
            </div>
            </div>
